...
# consumer = KafkaConsumer('kzmg_all_regist',auto_offset_reset='earliest',bootstrap_servers=['172.23.11.150:9092'])
consumer = KafkaConsumer('kzmg_all_regist', bootstrap_servers=['172.23.11.150:9092'])
print (consumer.partitions_for_topic("kzmg_all_regist"))  # 获取phone-game-userinfo主题的分区信息
print (consumer.topics())  # 获取主题列表
print (consumer.subscription())  # 获取当前消费者订阅的主题
print (consumer.assignment())  # 获取当前消费者topic、分区信息
print (consumer.beginning_offsets(consumer.assignment()))  # 获取当前消费者可消费的偏移量
print(consumer.end_offsets(consumer.assignment()))
consumer.seek(TopicPartition(topic=u'kzmg_all_regist', partition=0), 0)
...
print (dir(client))
filePath = '/user/kzcq/datatest/kzmg_regist.json'
tag_list = []
